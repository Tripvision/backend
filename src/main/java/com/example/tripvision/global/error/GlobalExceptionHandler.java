...
/**
 * <h4> Exception 핸들링을 위한 컨트롤러 클래스 입니다. </h4>
 */
...
public class GlobalExceptionHandler {
	...
	protected ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(
		...
		log.error("handleMethodArgumentNotValidException", methodArgumentNotValidException);
	...
	protected ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(
		...
		final ErrorResponse response = ErrorResponse.of(methodArgumentTypeMismatchException);
		return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
	}
	...
	protected ResponseEntity<ErrorResponse> handleAccessDeniedException(AccessDeniedException accessDeniedException) {
	...
	protected ResponseEntity<ErrorResponse> handleBusinessException(final BusinessException businessException) {
		log.error("handleEntityNotFoundException", businessException);
		log.error(businessException.toString());
		businessException.getStackTrace();
